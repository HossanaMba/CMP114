...
class BankApp:
    def __init__(self):
        ...
        self.login_window.title('FinEdge BANK')
    ...
    def deposit_savings(self):
        ...
        if amount is not None:
            if amount <= 5000:
                ...
                messagebox.showerror('Deposit Failed', 'You can only deposit up to 5000.')
    ...
    def withdraw_savings(self):
        ...
        if amount is not None:
            if amount <= 10000:
                ...
                messagebox.showerror('Withdrawal Failed', 'Insufficient funds. You can only withdraw up to 10000.')
